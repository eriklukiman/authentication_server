...
class RecordExistsExcept extends Base {
  /**
   * Invalid message
   * 
   * @var string
   * */
  protected $message = 'The ":value" is not found.';
  ...
  public function check(mixed $value): bool {
    ...
    $this->requireParameters(['table', 'column', 'except']);
    ...
    $isRecordExist = $this->query->table($this->parameter('table'))
      ...
      ->where($this->parameter('column'), $this->parameter('except'), '<>')
